...
var Index = function (_Component) {
    ...
    function Index(props) {
        ...
        _this.handleTouchStart = function (e) {
            ...
            if (_this.props.loop) {
                if (_this.state.index == _this.slides - 1) {
                    ...
                    _this.setState({
                        styles: {
                            translateX: -($this.state.index + $this.slides) * _this.clientWidth * 0.85 + _this.clientWidth * 0.05,
                            duration: 0
                        },
                        index: $this.state.index + $this.slides
                    });
                    _this.distances = -($this.state.index + 4) * _this.clientWidth * 0.85 + _this.clientWidth * 0.05;
                    ...
                    _this.distances = -($this.state.index - $this.slides) * _this.clientWidth * 0.85 + _this.clientWidth * 0.05;
                } else {
                    _this.setState({
                        styles: {
                            duration: 0
        ...
        _this.handleTouchMove = function (e) {
            ...
            _this.scale = Math.abs(0.2 * distance / _this.clientWidth * 0.85);
            if (!_this.props.loop) {
                ...
                } else if (_this.distances + distance < -_this.clientWidth * 0.85 * (_this.slides - 1 - 0.05)) {
                    if (distance > 0) {
                        distance = Math.sqrt(distance);
                    } else {
                        distance = -Math.sqrt(-distance);
        ...
        _this.setMyState = function (index) {
            _this.setState({
                styles: {
                    translateX: -index * _this.clientWidth * 0.85 + _this.clientWidth * 0.05,
                    duration: .5
                },
                index: index
            });
                    ...
                    _this.timerOut = setTimeout(function () {
                        $this.setState(function (_ref) {
                            ...
                            return {
                                styles: {
                                    duration: 0,
                                    translateX: -(index + _this.slides) * _this.clientWidth * 0.85 + _this.clientWidth * 0.05
                                },
        ...
        _this.state = {
            styles: {
                translateX: _this.props.loop && -(_this.props.index + _this.props.children.length) * _this.clientWidth * 0.85 + _this.clientWidth * 0.05 || -_this.props.index * _this.clientWidth * 0.85 + _this.clientWidth * 0.05,
    ...
    _createClass(Index, [{
        ...
        value: function render() {
            ...
            for (var k = 0; k < j; k++) {
                children.map(function (item, i) {
                    sliderDom.push(_react2.default.createElement(
                        'div',
                        { key: 10 * i + k, className: 'swiper_slide', style: _this3.state.index % children.length == i && slide_style_active || slide_style },
                        item
                    ));
                });
            }
            ...
            return _react2.default.createElement(
                'div',
                { className: 'swiper_container', style: styles.swiper_container, ref: 'swiper', onTouchStart: this.handleTouchStart, onTouchMove: this.handleTouchMove, onTouchEnd: this.handleTouchEnd },
                _react2.default.createElement(
                    'div',
                    { className: 'swiper_wrapper', style: wrapper_style },
                    sliderDom
                )
            );
        }
